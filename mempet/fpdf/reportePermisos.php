...
$act = pg_query("SELECT  id_permiso, cedula, tipo, motivo, fecha_ini, fecha_cul from tbl_permisos ORDER BY cedula");
...
$head = array("Id", "Cedula","Tipo de Permiso","Motivo del Permiso","Fecha de Inicio","Fecha de Culminacion"); // cabecera
$i=0;
...
$pdf->Cell(180,1,"Cumana: ".date("j-m-y"),0,0,'R');
$pdf->Ln(5);
$pdf->SetFont('Arial','B',10);
