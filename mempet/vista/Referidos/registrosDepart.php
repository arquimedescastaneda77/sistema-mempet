    ...
    <header>
        ...
        <div class="grid-100 decoration2">
             ...
             <div class="grid-100 grid-container grid-parent">
                ...
                <div class="grid-25  grid-parent">
                   <a href="../personal/registrarPersonal.php">Personal</a>
                </div>
                ...
                <div class="grid-25  grid-parent">
                 ...
                 <div class="grid-25  grid-parent">
                    <a href="registrosDepart.php">Referidos</a>
                </div>
            ...
            <div id="tab-body-1" class="tab-body">
                ...
                <div class=" push-20 grid-60 grid-conteiner grid-parent  grid-container mobile-grid-100  form1">
                    ...
                    <div class="grid-50 grid-parent  grid-container mobile-grid-100">
                        ...
                        <input class="form2" type="text" name="departamento">

                        <label>Encargado</label>
                        <input class="form2" name="encargado" type="text" required="required">

                        <label>Extension</label>
                        <input class="form2" type="text" name="extension">
                    </div>
                    ...
                    <div class="grid-50 grid-parent  grid-container mobile-grid-100">
                        ...
                        <input class="form2" type="text" name="zona" required="required">

                        <label>Agrupar</label>
                        <input class="form2" type="text" name="grupo" required="required">
                ...
                <div align="center" id="tab-body-2" class="tab-body">
                    ...
                    <div class=" push-20 grid-60 grid-conteiner grid-parent  grid-container mobile-grid-100  form1">
                            ...
                            <div class="grid-50 grid-parent  grid-container mobile-grid-100">
                                ...
                                <input class="form2" type="text" name="fecha_ini" required="required">
                              
                               <label>Tipo - Permiso</label>
                                <input class="form2" type="text" name="tipo" required="required">
                            ...
                            <div class="grid-50 grid-parent  grid-container mobile-grid-100">
                                ...
                                <input class="form2" type="text" name="trabajador" required="required">
                                
                                <label>Fecha - Final</label>
                                <input class="form2" type="textarea" name="fecha_cul" required="required">
